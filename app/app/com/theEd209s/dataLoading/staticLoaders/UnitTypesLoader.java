...
/**
 * This class will load the unit types into the database.
 * 
 * @author Matthew Weiler
 * */
public class UnitTypesLoader extends DataLoader
{	
	 ...
	 * */
	public static final String RELATIVE_UNIT_TYPES_SOURCE_FILE = "conf" + File.separatorChar + "unit_types.csv";
	
	/* CONSTRUCTORS */
	/**
	 * This will create a new instance of a {@link UnitTypesLoader}.
	 * */
	public UnitTypesLoader()
	{
		super(Play.application().getFile(UnitTypesLoader.RELATIVE_UNIT_TYPES_SOURCE_FILE), false);
	}
